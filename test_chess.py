...
class TestRook(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.board = Board()
        self.board.grid = {}  # On vide le VRAI dictionnaire du plateau !
        self.rook = Rook(0, Position('a', 1))
        self.board.grid['a1'] = self.rook
    ...
    def test_bloque_par_piece(self):
        ...
        self.board.grid['a3'] = Pawn(0, Position('a', 3))  # <-- Remplacer pieces par grid
    ...
    def test_capture_ennemi(self):
        ...
        self.board.grid['a5'] = Pawn(1, Position('a', 5))  # <-- Remplacer pieces par grid
        self.assertTrue(self.rook.isValidMove(Position('a', 5), self.board))

    def test_ne_capture_pas_allie(self):
        """La tour ne peut pas capturer un allié."""
        self.board.grid['a5'] = Pawn(0, Position('a', 5))  # <-- Remplacer pieces par grid
        self.assertFalse(self.rook.isValidMove(Position('a', 5), self.board))
